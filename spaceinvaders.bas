...
400 ' READSPRITE
410 READ WD, HT, CL
415 SP$(0)=CHR$(WD)+CHR$(HT)+CHR$(CL)  ' STORE METADATA
420 FOR L=1 TO HT
430 L$ = ""
440 FOR I = 1 TO WD
450 READ CH
...
600 ' DRAWPRITE
610 PT=P
615 MD$=SS$(SS,0): HT=ASC(LEFT$(MD$,1)) : WD=ASC(MID$(MD$,1,1))
620 FOR L = 1 TO HT
...
1124 DATA 128,143,143,143,143,143,143,128
1125 DATA 128,128,128,128,128,128,128,128

1030 ' BUNKER
1031 DATA 8, 4, 16
1032 DATA 128,136,143,143,143,143,138,128
1033 DATA 136,143,143,143,143,143,143,138
1034 DATA 143,143,143,143,143,143,143,143
